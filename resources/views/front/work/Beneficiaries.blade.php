        ...
        <section class="" data-bg-img="">
            <div class="container  pb-50">
                ...
                <div class="section-content ">
                    <div class="row">
                        <div class="col-md-12">
                            <h3 class="text-center text-black">Target Beneficiaries</h3>
                        </div>
                        <div class="col-md-12">
                                ...
                                <div class="col-md-10">
                                    <div class="causes-details clearfix p-15 pt-0 pb-10 pl-0">
                                        ...
                                        <p class="border-bottom pb-15">
                                            ...
                                            Poor People specially unemployed youths, women, Adolescent, Disabled,
                                            Landless, Marginal farmers, Widows, Children, Day labor who live below the
                                            poverty line and unemployed youths are the target beneficiaries of Compact
                                            Foundation(CF).
