        ...
        <section class="" data-bg-img="">
            <div class="container  pb-50">
                ...
                <div class="section-content ">
                    <div class="row">
                        <div class="col-md-12">
                            <h3 class="text-center text-black">Monitoring:</h3>
                        </div>
                        <div class="col-md-12">
                ...
                <div class="section-content">
                    <div class="row multi-row-clearfix">
                        <div class="col-sm-6 col-md-10">
                                ...
                                <div class="col-md-10">
                                    <div class="causes-details clearfix p-15 pt-0 pb-10 pl-0">
                                        ...
                                        <p class="border-bottom pb-15">
                                            ...
                                            <strong class="font-weight-bold">Compact Foundation </strong> has a strong monitoring & Evaluation team. CF
                                            take care of its Vision, Mission and core values. This development program is
                                            continually being monitored and evaluated to determine its progress and
                                            effectiveness, as well as to show where changes may be necessary. It is
                                            carried out in a participatory way with the participants.
                            ...
                            {{--                                <div class="widget">--}}
                            {{--                                    <h4 class="widget-title line-bottom">Search box</h4>--}}
